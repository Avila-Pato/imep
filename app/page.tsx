...
export default function Home() {
  ...
  return (
    <main className="scene w-screen relative h-screen  overflow-hidden bg-[url('/assets/landscape2.png')] bg-no-repeat bg-cover">
      ...
      <div className="p_text absolute lg:top-[55%] xl:left-[12%] xl:top-[75%] sm:left-[10%] sm:top-[70%] md:top-[60%] md:left-[20%] top-[72%] left-[5%] xl:translate-x-48 2xl:translate-x-56 md:translate-x-20
       xl:-translate-y-60 md:-translate-y-45  z-30  text-stone-200 tracking-wide [text-shadow:2px_4px_12px_rgba(0,0,0,0.5)]">
        <h2 className="xl:text-8xl lg:text-7xl md:text-6xl  text-[3rem]  text-center font-luxury">
          A
          <br />
          quién
        </h2>
      ...
      <div className=" p_text absolute lg:top-[-10%]  xl:top-[3%] md:top-[-0%] top-[52%] left-[25%] sm:left-[30%] sm:top-[50%]
       xl:left-[37%] 2xl:left-[40%]
       z-5
       text-stone-200 xl:text-[10rem] lg:text-[8rem] md:text-[6rem] sm:text-[3rem] text-[3.2rem] font-luxury leading-none
